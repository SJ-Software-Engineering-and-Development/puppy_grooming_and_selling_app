...
import com.example.new_puppy.fragment.AdminBookingListFragment;
import com.example.new_puppy.fragment.BookingSlotsFragment;
import com.example.new_puppy.model.BookingSlot;

import java.util.ArrayList;

public class AdminBookSlotGVAdapter extends ArrayAdapter<BookingSlot> {
    public AdminBookSlotGVAdapter(@NonNull Context context, ArrayList<BookingSlot> bookingSlotArrayList) {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        card.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AdminBookingListFragment.slotOnclick(bookingSlot.getId(), bookingSlot.isAvailable(), bookingSlot.getFromTime() +" - " + bookingSlot.getToTime());
            }
        });
